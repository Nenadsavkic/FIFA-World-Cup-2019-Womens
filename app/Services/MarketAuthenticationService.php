...
class MarketAuthenticationService
{
    ...
    /**
     * The client ID to identify client in the API
     * @var string
     */
    protected $clientId;
   ...
   /**
    * Generate URL to obtain users authorization
    * @return //string
    */
   public function resolveAuthorizationUrl()
   {
    ...
    public function getCodeToken($code)
    {
      ...
      /**
     * Obtain an access token the user credentials
     * @return stdClass 
     */
   ...
   /**
    * Stores a valid token with some atributes
    * @return void 
    */
   public function storeValidToken($tokenData, $grantType)
   {
         $tokenData->token_expires_at = now()->addSecond($tokenData->expires_in -20);         
